...
try:
	...
	if decision_temp.lower() == 'n':
		ask_exit('Update yt-dlp here: https://github.com/yt-dlp/yt-dlp?tab=readme-ov-file#installation')
	...
	for line in iter(process.stdout.readline, ''):
		if '[download]' in line:
			if ' Destination: ' in line:
				...
				print(f'\n{Fore.LIGHTCYAN_EX}[download]{Fore.RESET} '
					  f'{Fore.LIGHTYELLOW_EX}{filePath.name}{Fore.RESET}')
